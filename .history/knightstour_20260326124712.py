...
currentKnightPos, moveChoice, grid, placedKnights, done = game.execute('place', (0, 0))
currentKnightPos, moveChoice, grid, placedKnights, done = game.execute('place', (2, 1))
currentKnightPos, moveChoice, grid, placedKnights, done = game.execute('place', (4, 2))
